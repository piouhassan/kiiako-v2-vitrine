          ...
          <div className="max-w-[1400px] w-full mx-auto flex items-center justify-between">
            <div className='p-2'>
              <Link href="/" className="flex items-center">
                ...
                <figure className="lg:max-w-[150px] lg:block hidden">
                  <img src={isScrolled ? "/logo.png" : "/logo_kiiako_white@150x.png"} alt="Kiiako" className="dark:hidden block" />
                ...
                <figure className="max-w-[44px] sm:max-w-[150px] max-w-[120px] lg:hidden block">
                  <img src={isScrolled ? "/logo.png" : "/logo_kiiako_white@150x.png"} alt="Kiiako" className="w-full dark:hidden block" />
            ...
            <nav className="hidden xl:flex items-center overflow-visible">
              <ul className="flex items-center overflow-visible">
                ...
                >
                  <a href="#" className={`flex items-center gap-1 px-4 py-2 border border-transparent hover:border-stroke-2 dark:hover:border-stroke-7 rounded-full text-tagline-1 font-normal transition-all duration-200 ${
                      isScrolled
                                ...
                                >
                                  ...
                                  <div className="relative z-10 flex-1">
                                    <div className="flex items-center justify-between gap-2">
                                      <p className="text-tagline-1 font-normal text-secondary dark:text-accent">{feature.title}</p>
                ...
                <li className="relative nav-item cursor-pointer py-2.5">
                  <Link href="/tarifs" className={`flex items-center gap-1 px-4 py-2 border border-transparent hover:border-stroke-2 dark:hover:border-stroke-7 rounded-full text-tagline-1 font-normal transition-all duration-200 ${
                      isScrolled
                          ? 'text-secondary hover:text-secondary dark:text-accent dark:hover:text-accent'
                          : 'text-white hover:text-white'
                  }`}>
