    ...
    <section className="xl:py-[100px] md:pt-20 pb-[100px] md:pb-[180px] lg:pb-[200px] pt-16">
      <div className="main-container">
        <div className="text-center space-y-5 mb-14 md:mb-[70px]">
          <FadeIn delay={0.1}>
            <span className="badge bg-primary-500 text-white">{t('home.process.badge')}</span>
          </FadeIn>
          ...
          <div className="step-container max-w-[870px] mx-auto mb-[200px]">
            ...
            <FadeIn delay={0.4}>
              <div className="relative">
                ...
                <div className="absolute lg:left-0 lg:top-0 left-1/2 lg:translate-x-0 lg:translate-y-0 -translate-x-1/2 top-1/2 -translate-y-1/2 max-w-[370px] w-full space-y-3 lg:bg-none dark:bg-background-6 lg:dark:bg-transparent lg:p-0 lg:rounded-none p-6 rounded-[20px] max-lg:bg-background-4">
                  <p className="text-tagline-2 text-primary-500">{t('home.process.steps.1.label')}</p>
                  <div className="space-y-2">
                    <h3 className="text-heading-6 lg:text-heading-5">{t('home.process.steps.1.title')}</h3>
                    <p>{t('home.process.steps.1.description')}</p>
                  </div>
                </div>
              </div>
            </FadeIn>
            ...
            <FadeIn delay={0.5}>
              <div className="relative">
                ...
                <div className="absolute lg:right-0 lg:top-0 right-1/2 lg:translate-x-0 lg:translate-y-0 translate-x-1/2 top-1/2 -translate-y-1/2 max-w-[370px] w-full space-y-3 lg:bg-none dark:bg-background-6 lg:dark:bg-transparent lg:p-0 lg:rounded-none p-6 rounded-[20px] max-lg:bg-background-4">
                  <p className="text-tagline-2 text-primary-500">{t('home.process.steps.2.label')}</p>
                  <div className="space-y-2">
                    <h3 className="text-heading-6 lg:text-heading-5 max-w-[293px]">{t('home.process.steps.2.title')}</h3>
                    <p>{t('home.process.steps.2.description')}</p>
                  </div>
                </div>
              </div>
            </FadeIn>
            ...
            <FadeIn delay={0.6}>
              <div className="relative">
                ...
                <div className="absolute lg:left-0 lg:top-0 left-1/2 lg:translate-x-0 lg:translate-y-0 -translate-x-1/2 top-1/2 -translate-y-1/2 max-w-[370px] w-full space-y-3 lg:bg-none dark:bg-background-6 lg:dark:bg-transparent lg:p-0 lg:rounded-none p-6 rounded-[20px] max-lg:bg-background-4">
                  <p className="text-tagline-2 text-primary-500">{t('home.process.steps.3.label')}</p>
                  <div className="space-y-2">
                    <h3 className="text-heading-6 lg:text-heading-5 max-w-[236px]">{t('home.process.steps.3.title')}</h3>
                    <p>{t('home.process.steps.3.description')}</p>
                  </div>
                </div>
              </div>
            </FadeIn>
            ...
            <FadeIn delay={0.7}>
              <div className="relative">
                ...
                <div className="absolute lg:right-0 lg:top-0 right-1/2 lg:translate-x-0 lg:translate-y-0 translate-x-1/2 top-1/2 -translate-y-1/2 max-w-[370px] w-full space-y-3 lg:bg-none dark:bg-background-6 lg:dark:bg-transparent lg:p-0 lg:rounded-none p-6 rounded-[20px] max-lg:bg-background-4">
                  <p className="text-tagline-2 text-primary-500">{t('home.process.steps.4.label')}</p>
                  <div className="space-y-2">
                    <h3 className="text-heading-6 lg:text-heading-5 max-w-[236px]">{t('home.process.steps.4.title')}</h3>
                    <p>{t('home.process.steps.4.description')}</p>
                  </div>
                </div>
              </div>
            </FadeIn>
            ...
            <FadeIn delay={0.8}>
              <div className="relative">
                ...
                <div className="absolute lg:left-0 lg:top-0 left-1/2 lg:translate-x-0 lg:translate-y-0 -translate-x-1/2 top-16 max-w-[370px] w-full space-y-3 lg:bg-none dark:bg-background-6 lg:dark:bg-transparent lg:p-0 lg:rounded-none p-6 rounded-[20px] max-lg:bg-background-4">
                  <p className="text-tagline-2 text-primary-500">{t('home.process.steps.5.label')}</p>
                  <div className="space-y-2">
                    <h3 className="text-heading-6 lg:text-heading-5 max-w-[203px]">{t('home.process.steps.5.title')}</h3>
                    <p>{t('home.process.steps.5.description')}</p>
                  </div>
                </div>
              </div>
            </FadeIn>
