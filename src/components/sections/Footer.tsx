...
import { Facebook_link, X_link, Youtube_link, Linkedin_link, instagram_link } from '@/lib/utls';
        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-8 pb-16 border-b border-white/10 dark:border-white/5">
          ...
          <div className="lg:w-1/3 flex flex-col items-start pr-0 lg:pr-12">
            ...
            <div className="flex items-center gap-4 mt-auto">
               <a href={Facebook_link} target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-white transition-colors" aria-label="Facebook">
               ...
               <a href={X_link} target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-white transition-colors" aria-label="X (Twitter)">
                 <svg className="w-[18px] h-[18px]" fill="currentColor" viewBox="0 0 24 24">
                   <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                 </svg>
               </a>
               <a href={instagram_link} target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-white transition-colors" aria-label="Instagram">
               ...
               <a href={Youtube_link} target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-white transition-colors" aria-label="Youtube">
               ...
               <a href={Linkedin_link} target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-white transition-colors" aria-label="LinkedIn">
