...
export default function TermsPage() {
  ...
  const sections = t('legalPages.terms.sections', { returnObjects: true }) as { title: string; content: string }[];
            ...
            <div className="space-y-6">
              <FadeIn delay={0.1}>
                <h1 className="text-heading-2 font-bold leading-tight tracking-tight">
                  <Trans i18nKey="legalPages.terms.title" components={{ 1: <span className="text-primary-500 italic" /> }} />
                </h1>
              </FadeIn>
              <FadeIn delay={0.2}>
