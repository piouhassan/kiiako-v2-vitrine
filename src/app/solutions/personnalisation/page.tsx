            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                ...
                <div className="space-y-6 p-8 rounded-2xl bg-background-1 dark:bg-background-6 border border-stroke-1 dark:border-stroke-7 hover:shadow-lg transition-all duration-300">
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-secondary/80 dark:text-accent/80">
                      Créez vos pages par simple glisser-déposer. Aucune compétence en code nécessaire pour créer une boutique professionnelle.
                    </p>
                  </div>
                </div>
              </FadeIn>
              ...
              <FadeIn delay={0.5}>
                <div className="space-y-6 p-8 rounded-2xl bg-background-1 dark:bg-background-6 border border-stroke-1 dark:border-stroke-7 hover:shadow-lg transition-all duration-300">
                  ...
                  <div className="space-y-3">
                    <h3 className="text-heading-5">Personnalisation complète des couleurs et fonts</h3>
                    <p className="text-secondary/80 dark:text-accent/80">
              ...
              <FadeIn delay={0.7}>
                <div className="space-y-6 p-8 rounded-2xl bg-background-1 dark:bg-background-6 border border-stroke-1 dark:border-stroke-7 hover:shadow-lg transition-all duration-300">
                  ...
                  <div className="space-y-3">
                    <h3 className="text-heading-5">Prévisualisation en temps réel</h3>
                    <p className="text-secondary/80 dark:text-accent/80">
                      Visualisez instantanément vos modifications avant de les publier. Ce que vous voyez est exactement ce que vos clients verront.
                    </p>
                  </div>
                </div>
              </FadeIn>
