...
export default function LegalPage() {
  ...
  const sections = t('legalPages.legal.sections', { returnObjects: true }) as { title: string; content: string }[];
